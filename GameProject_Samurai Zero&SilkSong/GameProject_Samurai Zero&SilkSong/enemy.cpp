...
Enemy::Enemy()
{
	...
	collision_box_silk->set_enabled(false);
	{
		...
		}
		{
			...
			animation_fall_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_fall_left")
			);
			...
			animation_fall_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_fall_right")
			);
		}

		{
			...
			animation_idle_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_idle_left")
			);
			...
			animation_idle_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_idle_right")
			);
		}
		{
			...
			animation_jump_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_jump_left")
			);
			...
			animation_jump_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_jump_right")
			);
		}

		{
			...
			animation_run_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_run_left")
			);
			...
			animation_run_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_run_right")
			);
		}
		{
			...
			animation_squat_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_squat_left")
			);
			...
			animation_squat_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_squat_right")
			);
		}

		{
			...
			animation_throw_barb_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_barb_left")
			);
			...
			animation_throw_barb_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_barb_right")
			);
		}
		{
			...
			animation_throw_silk_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_silk_left")
			);
			...
			animation_throw_silk_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_silk_right")
			);
		}

		{
			...
			animation_throw_sword_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_sword_left")
			);
			...
			animation_throw_sword_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_throw_sword_right")
			);
		}
		{
			...
			animation_silk.add_frame(
				ResourcesManager::instance()->find_atlas("silk")
			);
			...
			animation_dash_in_air_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_vfx_dash_in_air_left")
			);
			...
			animation_dash_in_air_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_vfx_dash_in_air_right")
			);
			...
			animation_dash_on_floor_left.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			animation_dash_on_floor_left.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_vfx_dash_on_floor_left")
			);
			...
			animation_dash_on_floor_right.set_anchor_mode(Animation::AnchorMode::BottomCentered);
			animation_dash_on_floor_right.add_frame(
				ResourcesManager::instance()->find_atlas("enemy_vfx_dash_on_floor_right")
			);
		}
