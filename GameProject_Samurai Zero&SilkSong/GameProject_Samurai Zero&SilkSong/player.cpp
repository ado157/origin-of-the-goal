...
Player::Player()
{
	...
	timer_attack_cd.set_wait_time(CD_ROLL);
	...
	animation_attack_left.add_frame(
		ResourcesManager::instance()->find_image("player_attack_left"), 5
	);
	...
	animation_attack_right.add_frame(
		ResourcesManager::instance()->find_image("player_attack_right"), 5
	);
	...
	animation_dead_left.add_frame(
		ResourcesManager::instance()->find_image("player_dead_left"), 6
	);
	...
	animation_dead_right.add_frame(
		ResourcesManager::instance()->find_image("player_dead_right"), 6
	);
	...
	animation_fall_left.add_frame(
		ResourcesManager::instance()->find_image("player_fall_left"), 5
	);
	...
	animation_fall_right.add_frame(
		ResourcesManager::instance()->find_image("player_fall_right"), 5
	);
	...
	animation_idle_left.add_frame(
		ResourcesManager::instance()->find_image("player_idle_left"), 5
	);
	...
	animation_idle_right.add_frame(
		ResourcesManager::instance()->find_image("player_idle_right"), 5
	);
	...
	animation_jump_left.add_frame(
		ResourcesManager::instance()->find_image("player_jump_left"), 5
	);
	...
	animation_roll_left.add_frame(
		ResourcesManager::instance()->find_image("player_roll_left"), 7
	);
	...
	animation_roll_right.add_frame(
		ResourcesManager::instance()->find_image("player_roll_right"), 7
	);
	...
	animation_run_left.add_frame(
		ResourcesManager::instance()->find_image("player_run_left"), 10
	);
	...
	animation_run_right.add_frame(
		ResourcesManager::instance()->find_image("player_run_right"), 10
	);
	...
	animation_slash_up.add_frame(
		ResourcesManager::instance()->find_image("player_vfx_attack_up"), 5
	);
	...
	animation_slash_down.add_frame(
	...
	animation_slash_left.add_frame(
	...
	animation_slash_right.add_frame(
...
void Player::on_input(const ExMessage& msg)
{
	...
	case WM_RBUTTONDOWN:
		...
		BulletTimerManager::instance()->set_status(BulletTimerManager::Status::Entering);
		break;
	case WM_RBUTTONUP:
		stop_audio(_T("bullet_time"));
		BulletTimerManager::instance()->set_status(BulletTimerManager::Status::Exiting);	
		break;
	}
}
