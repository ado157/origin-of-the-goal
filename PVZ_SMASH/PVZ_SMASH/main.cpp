...
IMAGE img_sunflower_selector_background_left;    // 选角界面朝向左的太阳花背景图片
IMAGE img_sunflower_selector_background_right;   // 选角界面朝向右的太阳花背景图片
...
{
	AddFontResourceEx(_T("resources/Pix.ttf"), FR_PRIVATE, NULL);
