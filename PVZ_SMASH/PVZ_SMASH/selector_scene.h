...
extern IMAGE img_1P;                               // 1P “’ ı◊÷Õº∆¨
extern IMAGE img_2P;                               // 2P “’ ı◊÷Õº∆¨
...
extern IMAGE img_sunflower_selector_background_left;    // —°Ω«ΩÁ√Ê≥ØœÚ◊ÛµƒÃ´—Ùª®±≥æ∞Õº∆¨
extern IMAGE img_sunflower_selector_background_right;   // —°Ω«ΩÁ√Ê≥ØœÚ”“µƒÃ´—Ùª®±≥æ∞Õº∆¨

extern Atlas atlas_peashooter_idle_right;       // Õ„∂π…‰ ÷≥ØœÚ”“µƒƒ¨»œ∂Øª≠ÕººØ
extern Atlas atlas_sunflower_idle_right;        // ¡˙»’ø˚≥ØœÚ”“µƒƒ¨»œ∂Øª≠ÕººØ

extern IMAGE img_avatar_peashooter;    // Õ„∂π…‰ ÷Õ∑œÒÕº∆¨
...
public:
	...
	void on_enter()
	{
		...
		pos_img_1P_gravestone.y = pos_img_1P.y + img_1P.getheight() / 2 + 35;
