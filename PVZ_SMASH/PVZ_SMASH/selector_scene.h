...
extern IMAGE img_1P;                               // 1P ÒÕÊõ×ÖÍ¼Æ¬
extern IMAGE img_2P;                               // 2P ÒÕÊõ×ÖÍ¼Æ¬
...
extern IMAGE img_peashooter_selector_background_left;   // Ñ¡½Ç½çÃæ³¯Ïò×óµÄÍã¶¹ÉäÊÖ±³¾°Í¼Æ¬
extern IMAGE img_peashooter_selector_background_right;  // Ñ¡½Ç½çÃæ³¯ÏòÓÒµÄÍã¶¹ÉäÊÖ±³¾°Í¼Æ¬
extern IMAGE img_sunflower_selector_background_left;    // Ñ¡½Ç½çÃæ³¯Ïò×óµÄÌ«Ñô»¨±³¾°Í¼Æ¬
extern IMAGE img_sunflower_selector_background_right;   // Ñ¡½Ç½çÃæ³¯ÏòÓÒµÄÌ«Ñô»¨±³¾°Í¼Æ¬
