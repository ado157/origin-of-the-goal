...
extern IMAGE img_1P;                               // 1P 艺术字图片
extern IMAGE img_2P;                               // 2P 艺术字图片
...
extern IMAGE img_sunflower_selector_background_left;    // 选角界面朝向左的太阳花背景图片
extern IMAGE img_sunflower_selector_background_right;   // 选角界面朝向右的太阳花背景图片
